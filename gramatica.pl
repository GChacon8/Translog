...
sustantivo(n(n_4),m,pl)-->[gatos].
sustantivo(n(n_4),f,sg)-->[gata].
sustantivo(n(n_4),f,pl)-->[gatas].


sustantivo(n(n_5),f,sg)-->[rata].
sustantivo(n(n_5),f,pl)-->[ratas].


sustantivo(n(n_6),m,sg)-->[pez].
sustantivo(n(n_6),m,pl)-->[peces].

sustantivo(n(n_7),m,sg)-->[raton].
sustantivo(n(n_7),m,pl)-->[ratones].

sustantivo(n(n_8),f,sg)-->[ave].
sustantivo(n(n_8),f,pl)-->[aves].

%personas
sustantivo(n(n_9),m,sg)-->[joven].
sustantivo(n(n_9),m,pl)-->[jovenes].

sustantivo(n(n_10),m,sg)-->[hijo].
sustantivo(n(n_10),m,pl)-->[hijos].

sustantivo(n(n_11),f,sg)-->[hija].
sustantivo(n(n_11),f,pl)-->[hijas].

sustantivo(n(n_12),f,sg)-->[mama].
sustantivo(n(n_12),f,sg)-->[mamas].

sustantivo(n(n_13),m,sg)-->[papa].
sustantivo(n(n_13),m,pl)-->[papas].

sustantivo(n(n_14),m,sg)-->[nino].
sustantivo(n(n_14),m,pl)-->[ninos].

sustantivo(n(n_15),f,sg)-->[nina].
sustantivo(n(n_15),f,pl)-->[ninas].

sustantivo(n(n_16),m,sg)-->[abuelo].
sustantivo(n(n_16),m,pl)-->[abuelos].
...
sustantivo(n(n_24),m,pl)-->[animales].


sustantivo(n(n_25),f,sg)-->[respuesta].
sustantivo(n(n_25),f,pl)-->[respuestas].

sustantivo(n(n_26),f,sg)-->[manzana].
sustantivo(n(n_26),f,pl)-->[manzanas].
...
sustantivo(n(n_38),m,pl)-->[libros].

sustantivo(n(n_39),f,sg)-->[caja].
sustantivo(n(n_39),f,pl)-->[cajas].
